// File: generate_nodejs.go
// Purpose: Node.js-specific code generation for Express and Fastify frameworks
// Contains all logic for generating Node.js BFF projects
